...
namespace Drupal\Tests\science\Functional;
...
class SciencePublisherTest extends BrowserTestBase {
  ...
  public function testSciencesPublisher\() {
    ...
    // Configure the block.
    $this->drupalGet('admin/structure/block/add/system_menu_block:main/science');
    ...
    // science profile modules are enabled.
    ...
    // Ensure that configuration from the SciencePublish profile is not reused when
